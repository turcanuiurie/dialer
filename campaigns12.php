			...
			<ul>
			    ...
			    <li><a href="start.php"><span>Start Campaign</span></a></li>
		            <li><a href="admins.php"><span>Administrators</span></a></li>
										<li><a href="CDR.php"><span>CDR</span></a></li>
				...
				<div class="box">
					...
					<form  name="form1" id="contact-form" >
						...
						<div class="form">
								...
								<p>
								<input type="button" value="Delete Campaign" class="homebutton" id="btnHome" 
onClick="document.location.href=if (isset($_POST['submit'])) {
